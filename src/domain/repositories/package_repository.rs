use crate::domain::entities::{CacheInfo, CleanupPreview, Package, PackageType};
use anyhow::Result;
...
pub trait PackageRepository: Send + Sync {
    ...
    async fn get_available_packages(&self, package_type: PackageType) -> Result<Vec<Package>>;
